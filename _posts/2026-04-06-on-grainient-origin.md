---
layout: post
title: On How Grainient Was Born
...
<figure>
    <img src="https://i.imgur.com/OQolX6l.png" alt="Grainient iOS App" style="width:100%">
        <figcaption style="text-align: center;">
        Grainient iOS App<br>
    </figcaption>
</figure>

[Grainient](https://apps.apple.com/ge/app/grainient/id6761453920) is my first iOS app, and this is a short story of how it came to life.

I’ve had a long-standing obsession with grainy gradients for a while now. It probably started with Arc *([the one true browser from The Browser Company](https://arc.net/))*, and with my completely healthy habit of wanting to steal every beautiful color combination and pattern I see around me. More recently, I also became a huge fan of the [React Bits component library](https://www.reactbits.dev/get-started/index), especially its grainient component.

On their own, these facts are not particularly remarkable. But the other day, [Tornike](https://www.linkedin.com/in/tornikeo/) and I were sitting in the office after an exhausting workday and decided to block off an hour to brainstorm random, non-work-related ideas and build something small for fun *(yep, I sometimes question our definition of fun too)*.
...
- A home screen with a `+` button that opens the camera or photo library
- A photo selection flow with zoom support
- Extraction of the three main colors from the selected photo
- Turning those colors into grainients, along with matching color swatches
...
Check it out [here](https://apps.apple.com/ge/app/grainient/id6761453920) and let me know if you love it or love it. And don’t forget to share your favorite grainients.
...
*Thanks to [**Tornike Onoprishvili**](https://www.linkedin.com/in/tornikeo/) for not reading any drafts of this.*
